...
public class WalletStatement implements Parcelable {
    ...
    public WalletStatement(int statement_id, String statement_student, String statement_date,
                           double statement_tuition, double statement_insurance,
    ...
    public String toString() {
        return "WalletStatement{" +
                ...
                ", statement_tuition=" + statement_tuition +
                ", statement_insurance=" + statement_insurance +
                ", statement_diverse_services=" + statement_diverse_services +
                '}';
    }
